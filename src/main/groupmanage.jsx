    ...
    return (
        <div className="card">
            ...
            <div  className='h-1/2 items-center flex px-10 gap-3'>
                <Link to="/">
                <button className='h-14 bg-blue-600 px-2 rounded-lg text-white'>
                        <i className="fas fa-home mr-2"></i> Home
                    </button>
                </Link>
                <p className='text-4xl'><strong> Manage Group </strong></p>
                </div>
                    
                

                <div className='flex flex-wrap gap-2 justify-content-between px-10 items-center h-1/2'>
                    ...
                    <button className='h-10 bg-green-600 px-2 rounded-lg text-white'>
                        <i className='fas fa-plus mr-2'></i>
                        Add
                    </button>
                    <button
                        className='h-10 bg-red-600 px-2 rounded-lg text-white'
                    ...
                    <button className='h-10 bg-blue-600 px-2 rounded-lg text-white'>
                    ...
                    {currentCustomers.length > 0 ? (
                        currentCustomers.map((customer) => (
                            <tr key={customer.id}>
                                ...
                                <td className="border px-4 py-2">{customer.balance.toLocaleString('en-US', { style: 'currency', currency: 'USD' })}</td>
                                ...
                                <td className="border px-4 py-2">
                                    <button className='h-8 w-8 bg-gray-400 rounded-full'>
                                        ⚙️
                                    </button>
                                </td>
                            </tr>
